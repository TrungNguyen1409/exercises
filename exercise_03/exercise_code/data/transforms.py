...
def compute_image_mean_and_std(images):
    ...
    mean = np.mean(images, axis=(0, 1, 2))  # Compute mean across N, H, W axes for each channel
    std = np.std(images, axis=(0, 1, 2))    # Compute std across N, H, W axes for each channel
...
class NormalizeTransform:
    ...
    def __call__(self, images):
        ...
        # If mean and std are arrays, apply them channel-wise
